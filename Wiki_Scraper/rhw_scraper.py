...
h3 = html.find(string="Weapon Data")
...
'''
	The following is the general structure of a Right Handed Weapon
		weapon_name = {
...
for link in links:
	...
	right_handed_weapons[name] = current_item

	print("nabbed item")

# now that we've gotten all the items, dump them as a json file
with open('right_handed_weapons.json' , 'w') as f:
	json.dump(right_handed_weapons , f)
